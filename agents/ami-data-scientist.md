...
- **Execute Skill:** `ami-sql-optimizer` (View `skills/ami-sql-optimizer/SKILL.md`).
...
- **Execute Skill:** `ami-data-profiler` (View `skills/ami-data-profiler/SKILL.md`).
...
- **Execute Skill:** `ami-data-validator` (View `skills/ami-data-validator/SKILL.md`).
...
- **Execute Skill:** `ami-dashboard-builder` (View `skills/ami-dashboard-builder/SKILL.md`).
