...
11. **PR Verification:** Before creating a Pull Request or proposing its creation, the AI MUST run the `ami-pr-conflict-detector` skill (or suggest it to the user) to identify potential conflicts with other open PRs.
