...
| **[`learning/`](learning/)** | **Persistent AI Memory & Learnings:** Knowledge repository where the AI preserves patterns, architectural takeaways, and structural lessons across coding sessions. <br> <ul><li>[`adversarial-architecture-and-context-deduplication.md`](learning/adversarial-architecture-and-context-deduplication.md)</li><li>[`ai-context-token-optimization-and-hook-deduplication.md`](learning/ai-context-token-optimization-and-hook-deduplication.md)</li><li>[`atomic-commit-boundaries-across-distribution-layers.md`](learning/atomic-commit-boundaries-across-distribution-layers.md)</li><li>[`atomic-releases-and-ci-ghost-commit-elimination.md`](learning/atomic-releases-and-ci-ghost-commit-elimination.md)</li><li>[`cli-environment-version-manifest-tracking.md`](learning/cli-environment-version-manifest-tracking.md)</li><li>[`cli-ux-dependency-bloat.md`](learning/cli-ux-dependency-bloat.md)</li><li>[`cross-platform-cli-and-multi-shell-hooks.md`](learning/cross-platform-cli-and-multi-shell-hooks.md)</li><li>[`dry-agent-skill-architecture.md`](learning/dry-agent-skill-architecture.md)</li><li>[`fresh-build-and-artifact-gate-protocol.md`](learning/fresh-build-and-artifact-gate-protocol.md)</li><li>[`github-actions-post-trigger-verification.md`](learning/github-actions-post-trigger-verification.md)</li><li>[`graceful-feature-deprecation-advisories.md`](learning/graceful-feature-deprecation-advisories.md)</li><li>[`idempotent-markdown-mutation-and-ai-rules-distribution.md`](learning/idempotent-markdown-mutation-and-ai-rules-distribution.md)</li><li>[`utf8-bom-sanitization-and-frontmatter-diagnostics.md`](learning/utf8-bom-sanitization-and-frontmatter-diagnostics.md)</li></ul> |
