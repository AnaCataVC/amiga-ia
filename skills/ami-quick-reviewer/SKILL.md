...
description: Performs a static analysis of modified or untracked files before a commit to ensure code quality.
allowed-tools: Bash, Read, Grep
---

# Skill: Code Review

When this skill is invoked, you must act as a strict but quick Code Reviewer.
...
3. **Report:** 
   ...
   - If everything is perfect, let the user know and terminate the skill.
